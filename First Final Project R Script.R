#For this movie recommendation project, we will download the 10M version
#  of movielens. We will split it into a train set (edx) and test set (validation)

##########################################################
# Creating edx set, validation set (final hold-out test set)
##########################################################
...
#Step 1. Splitting the data into training and test sets. We will put 20 
#  percent of the data into the test set with p=0.2 in the createDataPartition 
#  function
